...
void RefuseGame(bool& aCantPlay)
{
	...
	std::cout << "You start to wonder why. You eventually land on the question 'Maybe I've won too much?'." << std::endl;
	Pause();
	ClearConsole();
	EnterGamePicker();
}
...
void GameOver()
{
	...
	Pause();
	std::cout << "Two burly guards lift you by your collar and throw you out onto the street into the rain." << std::endl;
	Pause();
...
void CashOut()
{
	...
	Pause();
	std::cout << "Your grin widens, as if you were to mock the casino for everything they put you through." << std::endl;
	Pause();
	std::cout << "You still didn't change your ways after coming home. You decided to go to a different casino." << std::endl;
	Pause();
	ClearConsole();
	ResetGame();
	EnterMainMenu();
